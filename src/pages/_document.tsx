      ...
      <body>
        ...
        <div className="modal">
          <div className="modal-box text-justify">
            <h3 className="font-bold text-lg">Kelas S1 - Sangat Sesuai</h3>
        ...
        <div className="modal">
          <div className="modal-box text-justify">
            <h3 className="font-bold text-lg">Kelas S2 - Cukup Sesuai</h3>
        ...
        <div className="modal">
          <div className="modal-box text-justify">
            <h3 className="font-bold text-lg">Kelas S3 - Sesuai Marginal</h3>
        ...
        <div className="modal">
          <div className="modal-box text-justify">
            <h3 className="font-bold text-lg">Kelas N - Tidak Sesuai</h3>
