...
import { getAllUser, activateUser, BaseUserResponse, DatumUser } from '@/services/adminService'
...
export default function Admin() {
  ...
  const { data: dataUser, isFetched: isFetchedUser } = useQuery<any>('getAllUser', getAllUser)
  ...
  useEffect(() => {
    if (isFetchedUser) {
      ...
      const newUserData: BaseUserResponse[] = modifyInActiveData.filter((data: DatumUser) => {
      ...
      <>
        ...
        <div className='py-40 px-20'>
          <div className='px-4 sm:px-6 lg:px-8 pb-16'>
            <div className='sm:flex sm:items-center'>
              <div className='sm:flex-auto'>
                <h1 className='text-base font-semibold leading-6 text-gray-900'>Daftar Pengguna Baru</h1>
                      ...
                      {newUser.map((person: any, idx: number) => (
                        <tr key={idx}>
                          ...
                          <td className='whitespace-nowrap px-3 py-4 text-sm text-gray-500'>
                            {formatMillis(Number(person.createdAt), 'EEEE, dd/MM/yyyy')}
                          </td>
                          <td className='whitespace-nowrap px-3 py-4 text-sm text-gray-500'>
          ...
          <div className='px-4 sm:px-6 lg:px-8 pb-16'>
            <div className='sm:flex sm:items-center'>
              <div className='sm:flex-auto'>
                ...
                <p className='mt-2 text-sm text-gray-700'>Daftar Pengguna Tidak Aktif & Butuh Perpanjangan Akun</p>
              </div>
            </div>
            <div className='mt-8 flow-root'>
              <div className='-mx-4 -my-2 overflow-x-auto sm:-mx-6 lg:-mx-8'>
          ...
          <div className='px-4 sm:px-6 lg:px-8'>
            <div className='sm:flex sm:items-center'>
              <div className='sm:flex-auto'>
                <h1 className='text-base font-semibold leading-6 text-gray-900'>Daftar Pengguna Aktif</h1>
                <p className='mt-2 text-sm text-gray-700'>Daftar Pengguna Aktif</p>
              </div>
            </div>
            <div className='mt-8 flow-root'>
              <div className='-mx-4 -my-2 overflow-x-auto sm:-mx-6 lg:-mx-8'>
