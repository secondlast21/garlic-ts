...
import { getAllInstitution, BaseInstitutionResponse, TGetInstitution } from '@/services/adminService'
...
export default function ActivateInstitution() {
  ...
  const { data: dataInstitutionFalse, isFetched: isFetchedInstitutionFalse } = useQuery<BaseInstitutionResponse>(
    'getAllInstitutionFalse',
    () => getAllInstitution(paramFalse)
  )
  const { data: dataInstitutionTrue, isFetched: isFetchedInstitutionTrue } = useQuery<BaseInstitutionResponse>(
    'getAllInstitutionTrue',
          ...
          <div className='px-4 sm:px-6 lg:px-8 pb-16'>
            <div className='sm:flex sm:items-center'>
              <div className='sm:flex-auto'>
                <h1 className='text-base font-semibold leading-6 text-gray-900'>Daftar Institusi Aktif</h1>
                <p className='mt-2 text-sm text-gray-700'>Daftar Institusi Aktif</p>
              </div>
            </div>
                ...
                <div className='inline-block min-w-full py-2 align-middle sm:px-6 lg:px-8'>
                  <table className='min-w-full divide-y divide-gray-300'>
                    ...
                    <tbody className='divide-y divide-gray-200'>
                      {allActiveInstitution?.map((institution: any, idx: number) => (
                        <tr key={idx}>
