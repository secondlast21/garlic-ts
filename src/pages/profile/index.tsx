...
export default function Profile() {
  ...
  const { data, isFetched } = useQuery<BaseCurrentUser>('getCurrentUser', currentUser)
                      ...
                      <div className='border-t border-gray-200'>
                        <dl>
                          <div className='bg-accent px-4 py-5 sm:grid sm:grid-cols-3 sm:gap-4 sm:px-6'>
                            <dt className='text-sm font-medium text-gray-900'>Nama Lengkap</dt>
                          ...
                          <div className='bg-accent px-4 py-5 sm:grid sm:grid-cols-3 sm:gap-4 sm:px-6'>
                            <dt className='text-sm font-medium text-gray-900'>Nomor Telepon</dt>
                            <dd className='mt-1 text-sm text-gray-900 sm:mt-0 sm:col-span-2'>{data?.data.phone}</dd>
                          </div>
                          <div className='bg-white px-4 py-5 sm:grid sm:grid-cols-3 sm:gap-4 sm:px-6'>
                            <dt className='text-sm font-medium text-gray-900'>Pekerjaan</dt>
                            <dd className='mt-1 text-sm text-gray-900 sm:mt-0 sm:col-span-2'>
                              {data?.data.profession}
                            </dd>
                          </div>
                          <div className='bg-accent px-4 py-5 sm:grid sm:grid-cols-3 sm:gap-4 sm:px-6'>
                            <dt className='text-sm font-medium text-gray-900'>Nama Institusi</dt>
                            <dd className='mt-1 text-sm text-gray-900 sm:mt-0 sm:col-span-2'>
                              {data?.data.institution.name}
                            </dd>
                          </div>
                          <div className='bg-white px-4 py-5 sm:grid sm:grid-cols-3 sm:gap-4 sm:px-6'>
                            <dt className='text-sm font-medium text-gray-900'>Alamat Institusi</dt>
                            <dd className='mt-1 text-sm text-gray-900 sm:mt-0 sm:col-span-2'>
