  ...
  return (
    <RequireAuth>
      <>
        ...
        <div className='m-32 grid grid-cols-3 gap-4 place-items-strecth'>
          <div>
            ...
            <table className='table-fixed border-collapse border border-black text-center'>
              <thead>
                <tr>
                  <th className='px-20 py-3 border-b border-black bg-accent font-black'>Label</th>
                  <th className='px-20 py-3 border-b border-black bg-accent font-black'>Kelas</th>
                </tr>
              </thead>
              <tbody>
                {drainaseOptions.map(({ label, kelas }, idx) => (
                  <tr key={idx}>
                    <td className='border-b border-t border-black px-4'>{capitalizeFirstLetter(label)}</td>
                    <td className='border-b border-t border-black px-4'>{setTitle(kelas)}</td>
                  </tr>
                ))}
              </tbody>
            </table>
        ...
        <p className='text-center'>*Informasi diatas bersumber dari Balai Besar Sumberdaya Lahan Pertanian</p>
        <Footer />
      </>
    </RequireAuth>
  )
