    ...
    <>
      ...
      <div className='flex flex-wrap pt-64 mx-8'>
        <div className='container mx-auto pb-40 w-7/12'>
          <div className='text-7xl m-5 font-display font-semibold text-black'>About</div>
          <div className='text-7xl m-5 font-display font-bold text-title'>INA Agro-GARLIC</div>
          ...
          <Link href='/about'>
            {' '}
            <button className='btn btn-accent m-5 px-16'>More Info</button>
          </Link>
        </div>
        <Image
          src={garlic}
      ...
      <div className='flex flex-wrap pt-40 mx-5'>
        ...
        <div className='container mx-auto pb-40 w-7/12'>
          <div className='text-7xl m-5 font-display font-semibold text-black'>About</div>
          <div className='text-7xl m-5 font-display font-bold text-title'>Bawang Putih</div>
          <div className='m-5 font-display text-black text-justify	'>
