const detail = [
  ...
  {
    title: 'Kelas S3 - Sesuai Marginal',
    modal: 'my-modal-3',
    keterangan:
  ...
  },
  {
    ...
    modal: 'my-modal-5',
    keterangan: 'Lahan belum memiliki nilai kesesuaian lahan.',
  },
]
