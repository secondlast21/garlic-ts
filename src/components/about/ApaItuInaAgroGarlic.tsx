  ...
  return (
    <div>
      ...
      <div className="mx-16 w-12/12 sm:7/12 md:7/12 text-lg text-center text-black">
        <div className="mb-6">
          <b>
            INA Agro-GARLIC (Agroecological Assessment of Land Suitability for
            Garlic) adalah Sistem Informasi Geografis Kesesuaian Agroekologi
            untuk Bawang Putih pada kawasan prioritas pengembangan lahan bawang
            putih di Indonesia.
          </b>
        </div>
        <p>
          Struktur klasifikasi kelas kesesuaian lahan mengikuti kerangka FAO
          (1976) yaitu
        </p>
