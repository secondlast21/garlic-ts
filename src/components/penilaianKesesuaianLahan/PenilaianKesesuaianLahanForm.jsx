...
export default function PenilaianKesesuaianLahanForm() {
  ...
  const [kapasitasTukarKationOptions, setKapasitasTukarKationOptions] = useState([])
  const [kedalamanMineralTanahOptions, setKedalamanMineralTanahOptions] = useState([])
  ...
  const fetchProvince = async () => {
    const data = await fetch('https://dev.farizdotid.com/api/daerahindonesia/provinsi')
    const json = await data.json()
    setProvince(json.provinsi)
  }

  const fetchKabupaten = async (id) => {
    const data = await fetch(`https://dev.farizdotid.com/api/daerahindonesia/kota?id_provinsi=${id}`)
    const json = await data.json()
    setKabupaten(json.kota_kabupaten)
  }

  const fetchKecamatan = async (id) => {
    const data = await fetch(`https://dev.farizdotid.com/api/daerahindonesia/kecamatan?id_kota=${id}`)
    const json = await data.json()
    setKecamatan(json.kecamatan)
  }

  const fetchKelurahan = async (id) => {
    const data = await fetch(`https://dev.farizdotid.com/api/daerahindonesia/kelurahan?id_kecamatan=${id}`)
    const json = await data.json()
  ...
  const formik = useFormik({
    ...
    onSubmit: (values) => {
      ...
      let result = {
        ...
        districtCode: String(kabupaten.find((d) => d.id == values['kabupaten/kota']).id),
        districtName: kabupaten.find((d) => d.id == values['kabupaten/kota']).nama,
        subDistrictCode: String(kecamatan.find((d) => d.id == values.kecamatan).id),
        subDistrictName: kecamatan.find((d) => d.id == values.kecamatan).nama,
        urbanVillageCode: String(kelurahan.find((d) => d.id == values['kelurahan/desa']).id),
        urbanVillageName: kelurahan.find((d) => d.id == values['kelurahan/desa']).nama,
    ...
    <div className='min-h-screen font-display flex bg-accent items-center justify-center py-24 px-4 sm:px-6 lg:px-8'>
      <div className='card w-1/2 bg-base-100 shadow-xl ml-10 mr-5'>
        ...
        <div className='card-body items-center text-center'>
          <h2 className='card-title'>Masukkan Data Syarat Tumbuh Bawang Putih</h2>
            ...
            <form onSubmit={formik.handleSubmit}>
              <div className='grid grid-cols-6 gap-6 my-8 mx-2'>
                <div className='mb-col-span-6 sm:col-span-3'>
                  ...
                  <input
                    ...
                    placeholder=''
                    onChange={(value) => {
                      formik.setFieldValue('observationDate', value.target.value)
                    }}
              ...
              <div className='text-justify'>
                ...
                <div className='col-span-6 sm:col-span-3 my-2'>
                  ...
                  <CustomSelect
                    onChange={(value) => formik.setFieldValue('temperatureId', value.value)}
                ...
                <div className='col-span-6 sm:col-span-3 my-2'>
                  ...
                  <CustomSelect
                    onChange={(value) => formik.setFieldValue('rainfallId', value.value)}
                ...
                <div className='col-span-6 sm:col-span-3 my-2'>
                  ...
                  <CustomSelect
                    onChange={(value) => formik.setFieldValue('sunshineDurationId', value.value)}
                ...
                <div className='col-span-6 sm:col-span-3 my-2'>
                  ...
                  <CustomSelect
                    onChange={(value) => formik.setFieldValue('elevationId', value.value)}
                ...
                <div className='col-span-6 sm:col-span-3 my-2'>
                  ...
                  <CustomSelect
                    onChange={(value) => formik.setFieldValue('reliefId', value.value)}
              ...
              <div className='text-justify'>
                ...
                <div className='col-span-6 sm:col-span-3 my-2'>
                  ...
                  <CustomSelect
                    onChange={(value) => formik.setFieldValue('soilMineralDepthId', value.value)}
                ...
                <div className='col-span-6 sm:col-span-3 my-2'>
                  ...
                  <CustomSelect
                    onChange={(value) => formik.setFieldValue('baseSaturationId', value.value)}
                ...
                <div className='col-span-6 sm:col-span-3 my-2'>
                  ...
                  <CustomSelect
                    onChange={(value) => formik.setFieldValue('soilAcidityId', value.value)}
              ...
              <div className='text-justify'>
                ...
                <div className='col-span-6 sm:col-span-3 my-2'>
                  ...
                  <CustomSelect
                    onChange={(value) => formik.setFieldValue('soilTextureId', value.value)}
                ...
                <div className='col-span-6 sm:col-span-3 my-2'>
                  ...
                  <CustomSelect
                    onChange={(value) => formik.setFieldValue('cationExchangeCapacityId', value.value)}
              ...
              <div className='min-h-full flex items-center justify-center px-4 sm:px-6 lg:px-8'>
                <button
                  className='btn btn-accent py-4 mt-8'
                  type='submit'
                >
                  Submit
                </button>
        ...
        <>
          <div className='card w-1/2 bg-base-100 shadow-xl ml-5 mr-10 p-5'>
            ...
            <h2 className={setResultTitle(Number(kesesuaianLahan?.land))}>
              Hasil Penilaian Kesesuaian Lahan : {namaLahan} - {setTitle(kesesuaianLahan?.land)}
            </h2>
            <div className='grid grid-cols-2 gap-4 justify-items-center'>
              <div className={setResultFactor(Number(kesesuaianLahan?.uncorrectableAndUncontrollableFactor))}>
                <div className='card-body'>
                  <h2 className='card-title'>
                    Faktor yang Tidak Dapat Dikendalikan dan Tidak Dapat Dikoreksi -{' '}
                    {setTitle(kesesuaianLahan?.uncorrectableAndUncontrollableFactor)}
                  </h2>
                </div>
              </div>
              <div className={setResultFactor(Number(kesesuaianLahan?.correctableFactor))}>
                <div className='card-body'>
                  <h2 className='card-title'>
                    Faktor yang Dapat Dikoreksi - {setTitle(kesesuaianLahan?.correctableFactor)}
                  </h2>
                </div>
              </div>
              <div className={setResultFactor(Number(kesesuaianLahan?.controllableFactor))}>
                <div className='card-body'>
                  <h2 className='card-title'>
                    Faktor yang Dapat Dikendalikan - {setTitle(kesesuaianLahan?.controllableFactor)}
                  </h2>
                </div>
              </div>
              <div className={setResultFactor(Number(syaratTumbuh?.[0]?.class))}>
                <div className='card-body'>
                  <h2 className='card-title'>Kedalaman Mineral Tanah - {setTitle(syaratTumbuh?.[0]?.class)}</h2>
                  <p>Rekomendasi : {syaratTumbuh?.[0]?.recommendation ?? 'Tidak ada rekomendasi'}</p>
                </div>
              </div>
              <div className={setResultFactor(Number(syaratTumbuh?.[1]?.class))}>
                <div className='card-body'>
                  <h2 className='card-title'>Drainase - {setTitle(syaratTumbuh?.[1]?.class)}</h2>
                  <p>Rekomendasi : {syaratTumbuh?.[1]?.recommendation ?? 'Tidak ada rekomendasi'}</p>
                </div>
              </div>
              <div className={setResultFactor(Number(syaratTumbuh?.[2]?.class))}>
                <div className='card-body'>
                  <h2 className='card-title'>Tekstur Tanah - {setTitle(syaratTumbuh?.[2]?.class)}</h2>
                  <p>Rekomendasi : {syaratTumbuh?.[2]?.recommendation ?? 'Tidak ada rekomendasi'}</p>
                </div>
              </div>
              <div className={setResultFactor(Number(syaratTumbuh?.[3]?.class))}>
                <div className='card-body'>
                  <h2 className='card-title'>Kemasaman Tanah - {setTitle(syaratTumbuh?.[3]?.class)}</h2>
                  <p>Rekomendasi : {syaratTumbuh?.[3]?.recommendation ?? 'Tidak ada rekomendasi'}</p>
                </div>
              </div>
              <div className={setResultFactor(Number(syaratTumbuh?.[4]?.class))}>
                <div className='card-body'>
                  <h2 className='card-title'>Kapasitas Tukar Kation - {setTitle(syaratTumbuh?.[4]?.class)}</h2>
                  <p>Rekomendasi : {syaratTumbuh?.[4]?.recommendation ?? 'Tidak ada rekomendasi'}</p>
                </div>
              </div>
              <div className={setResultFactor(Number(syaratTumbuh?.[5]?.class))}>
                <div className='card-body'>
                  <h2 className='card-title'>Kejenuhan Basa - {setTitle(syaratTumbuh?.[5]?.class)}</h2>
                  <p>Rekomendasi : {syaratTumbuh?.[5]?.recommendation ?? 'Tidak ada rekomendasi'}</p>
                </div>
              </div>
              <div className={setResultFactor(Number(syaratTumbuh?.[6]?.class))}>
                <div className='card-body'>
                  <h2 className='card-title'>Relief - {setTitle(syaratTumbuh?.[6]?.class)}</h2>
                  <p>Rekomendasi : {syaratTumbuh?.[6]?.recommendation ?? 'Tidak ada rekomendasi'}</p>
                </div>
              </div>
              <div className={setResultFactor(Number(syaratTumbuh?.[7]?.class))}>
                <div className='card-body'>
                  <h2 className='card-title'>Temperatur - {setTitle(syaratTumbuh?.[7]?.class)}</h2>
                  <p>Rekomendasi : {syaratTumbuh?.[7]?.recommendation ?? 'Tidak ada rekomendasi'}</p>
                </div>
              </div>
              <div className={setResultFactor(Number(syaratTumbuh?.[8]?.class))}>
                <div className='card-body'>
                  <h2 className='card-title'>Curah Hujan - {setTitle(syaratTumbuh?.[8]?.class)}</h2>
                  <p>Rekomendasi : {syaratTumbuh?.[8]?.recommendation ?? 'Tidak ada rekomendasi'}</p>
                </div>
              </div>
              <div className={setResultFactor(Number(syaratTumbuh?.[9]?.class))}>
                <div className='card-body'>
                  <h2 className='card-title'>Lama Penyinaran - {setTitle(syaratTumbuh?.[9]?.class)}</h2>
                  <p>Rekomendasi : {syaratTumbuh?.[9]?.recommendation ?? 'Tidak ada rekomendasi'}</p>
                </div>
              </div>
              <div className={setResultFactor(Number(syaratTumbuh?.[11]?.class))}>
                <div className='card-body'>
                  <h2 className='card-title'>Elevasi - {setTitle(syaratTumbuh?.[11]?.class)}</h2>
                  <p>Rekomendasi : {syaratTumbuh?.[11]?.recommendation ?? 'Tidak ada rekomendasi'}</p>
                </div>
              </div>
            </div>
